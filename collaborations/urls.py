...
urlpatterns = [
    ...
    path("<uuid:space_id>/files/table/", views.collaboration_files_table_partial, name="files_table"),
    path("<uuid:space_id>/files/upload/", views.collaboration_file_upload, name="file_upload"),
    path("<uuid:space_id>/files/upload-widget/", views.collaboration_upload_widget_partial, name="upload_widget"),
    path(
        "<uuid:space_id>/files/upload-widget/clear/",
        views.collaboration_upload_widget_clear,
        name="upload_widget_clear",
    ),
